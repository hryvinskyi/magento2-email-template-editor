    ...
    public function getEditorConfig(): string
    {
        ...
        $config = [
            'urls' => [
                ...
                'themeChangeScope' => $this->getUrl('emaileditor/theme/changeScope'),
                ...
                'knowledgeDescribe' => $this->getUrl('emaileditor/knowledge/describe'),
                'knowledgeSaveValue' => $this->getUrl('emaileditor/knowledge/saveValue'),
            ],
            'storeId' => $storeId,
